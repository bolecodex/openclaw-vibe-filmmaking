  ...
  return (
    ...
    >
      <div className="flex items-start gap-2">
        {pipelineStep ? (
          <span className="mt-0.5 flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-indigo-500/20 text-xs font-bold text-indigo-300">
            {pipelineStep}
          </span>
        ) : (
          <Circle
        ...
        <div className="min-w-0 flex-1">
          <div className="flex items-center gap-2">
            ...
            <span
              className={`shrink-0 rounded px-1.5 py-0.5 text-xs ${badge.className}`}
            >
              {badgeLabel}
            </span>
          </div>
